...
@endif
    ...
    <div 
        x-data="{ 
            forward: @entangle('forward'),
            curStep: @entangle('currentStep')
        }" 
        x-effect="console.log('curStep: ' + curStep + ' forward: ' + forward)">
        ...
        <div class="relative w-full">
            ...
            <div 
                ...
                <div 
                    class="flex items-center justify-center w-full transition ease-in-out duration-500 transform"
                    x-show="curStep == 1;"
                    x-bind="transition">
                    <div class="col-xs-12">
                        <div class="col-md-12">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <button 
                                ...
                                type="button" 
                                wire:click="backOne()">Back</button>
                            <button 
            ...
            <div 
                ...
                x-data="{
                    enter() {
                        return forward ? 'translate-x-full opacity-0' : '-translate-x-full opacity-0'
                    },
                    leave() {
                        return forward ? '-translate-x-full opacity-0' : 'translate-x-full opacity-0'
                    },
                    transition: {
                        'x-transition:enter-start'() { return this.enter() },
                        'x-transition:enter-end':    'translate-x-0 opacity-100',
                        'x-transition:leave-start':  'translate-x-0 opacity-100',
                        'x-transition:leave-end'()   { return this.leave() }
                    }
                }">
                <div 
                    class="flex items-center justify-center w-full transition ease-in-out duration-500 transform"
