            ...
            <div class="min-w-7xl w-full p-2 lg:p-4">
                <div class="flex justify-center">
                    <svg viewBox="106.3505 89.299 215.375 38.1553" width="400" height="70" xmlns="http://www.w3.org/2000/svg">
                      <text style="fill: rgb(14, 116, 144); font-family: Arial, sans-serif; font-size: 34px; font-weight: 700; text-anchor: middle; white-space: pre; text-decoration: underline solid rgba(0, 0, 0, 0.85);" x="214.038" y="120.299">Dirt Harmony</text>
                    </svg>
                </div>
